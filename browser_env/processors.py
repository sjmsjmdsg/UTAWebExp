...
class TextObervationProcessor(ObservationProcessor):
    ...
    def fetch_browser_info(
        ...
        # extract domtree, send commend to chrome and fetch domtree
...
class ObservationHandler:
    ...
    def get_observation(self, page: Page) -> dict[str, Observation]:
        text_obs = self.text_processor.process(page)  # also get domtree and bounds
        image_obs, content_str = self.image_processor.process(page)  # fetch the domtree twice??
        if content_str != "":
