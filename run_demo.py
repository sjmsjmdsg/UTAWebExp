...
def config() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--instruction_path",
        type=str,
        default=f"{root}/agent/prompts/jsons/p_som_cot_id_actree_3s.json",
    )
    parser.add_argument(
        "--parsing_failure_th",
    ...
    parser.add_argument("--intent", type=str, default="Help me navigate to a shirt that has this on it.")
    parser.add_argument("--image", type=str, default="https://media.npr.org/assets/img/2023/01/14/this-is-fine_wide-0077dc0607062e15b476fb7f3bd99c5f340af356-s1400-c100.jpg", help="url of images, seperated by |AND|")

    # logging related
    parser.add_argument("--result_dir", type=str, default=f"{root}/demo_test_amazon")
...
def prepare(args: argparse.Namespace) -> None:
    ...
    if not result_dir:
        result_dir = (
            f"{root}/cache/results_{time.strftime('%Y%m%d%H%M%S', time.localtime())}"
        )
